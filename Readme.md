...
* **Smart Clicking:** Single, double-click, and right-click support.
...
* **Snipping Tool:** Use a "V-sign" (Peace sign) to select and capture screen regions.
...
1. Clone the repo:
   ```bash
   git clone https://github.com/miidhunraj/Air-Gap.git
